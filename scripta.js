...
function mulaiketik1(){
  ...
  if(aa==vketik1.length){setTimeout(befanim,3200);setTimeout(gantikalimat2,2800);}
}
  ...
  function gantikalimat2(){setTimeout(anim,100);kalimat.innerHTML = "";kalimatb.innerHTML=vketik2;setTimeout(befanim,3200);setTimeout(gantikalimat3,2100);}
  ...
  function gantikalimat4(){fthilang();ftganti=2;setTimeout(ftmuncul,350);setTimeout(anim,100);kalimatc.innerHTML = "";kalimatd.innerHTML=vketik4;setTimeout(befanim,3200);setTimeout(gantikalimat5,2600);}
  ...
  function gantikalimat8(){fthilang();ftganti=2;setTimeout(ftmuncul,350);setTimeout(anim,100);kalimatg.innerHTML = "";kalimath.innerHTML=vketik8;setTimeout(befanim,3200);setTimeout(gantikalimat9,2300);}
